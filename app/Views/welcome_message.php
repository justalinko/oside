...
<head>
  ...
  <title>PORTAL DESA PECANGAAN KULON </title>
    ...
    <body id="page-top" data-spy="scroll" data-target=".side-menu">
      ...
      <div class="container-fluid">
        ...
        <div class="row hero-header" id="home">
          <div class="col-md-7">
            <img src="assets/img/meetup-logo.png" class="logo">
            <h1>Selamat datang, di Desa Pecangaan Kulon !</h1>
            <h3>Portal Desa L ayanan masyarakat berbasis IT </h3>
         <!--    <h4>20<sup>th</sup> to 22<sup>nd</sup>  October, 2015</h4> -->
            <a href="#" class="btn btn-lg btn-red">Buka Portal berita <span class="ti-arrow-right"></span></a>

          </div>
          <div class="col-md-5 hidden-xs">
            <img src="assets/img/8454.jpg" class="rocket animated bounce">
          </div>
        </div>
        <!-- End: Header -->
      </div>
      <div class="container">
        ...
        <div class="row me-row content-ct">
          <h2 class="row-title">Pencarian Data Kependudukan Desa</h2>
        ...
        <div class="row me-row content-ct speaker" id="speakers">
          ...
          <div class="col-md-4 col-sm-6 feature">
            <img src="assets/img/speaker-1.png" class="speaker-img">
            <h3>Simon Collins</h3>
          ...
          <div class="col-md-4 col-sm-6 feature">
            <img src="assets/img/speaker-2.png" class="speaker-img">
          ...
          <div class="col-md-4 col-sm-6 feature">
            <img src="assets/img/speaker-3.png" class="speaker-img">
            <h3>Harry Roberts</h3>
          ...
          <div class="col-md-4 col-sm-6 feature">
            <img src="assets/img/speaker-4.png" class="speaker-img">
            <h3>Geri Coady</h3>
            <p>Harry is a freelance designer, developer, writer, speaker and front-end architect from the UK, previously working as Senior UI Developer for Sky. He Tweets at...</p>
            <ul class="speaker-social">
              <li><a href="#"><span class="ti-facebook"></span></a></li>
          ...
          <div class="col-md-4 col-sm-6 feature">
            <img src="assets/img/speaker-5.png" class="speaker-img">
            <h3>Andy Budd</h3>
            <p>Harry is a freelance designer, developer, writer, speaker and front-end architect from the UK, previously working as Senior UI Developer for Sky. He Tweets at...</p>
            <ul class="speaker-social">
              <li><a href="#"><span class="ti-facebook"></span></a></li>
          ...
          <div class="col-md-4 col-sm-6 feature">
            <img src="assets/img/speaker-6.png" class="speaker-img">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="media">
                      <div class="media-left">
                        <a href="#">
                          <img class="media-object" src="assets/img/speaker-1.png" alt="...">
                        </a>
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="media">
                      <div class="media-left">
                        <a href="#">
                          <img class="media-object" src="assets/img/speaker-2.png" alt="...">
                        </a>
                      </div>
                      <div class="media-body">
                  ...
                  <div class="col-md-6">
                    <div class="media">
                      <div class="media-left">
                        <a href="#">
                          <img class="media-object" src="assets/img/speaker-3.png" alt="...">
                        </a>
                      </div>
                      <div class="media-body">
                  ...
                  <div class="col-md-6">
                    <div class="media">
                      <div class="media-left">
                        <a href="#">
                          <img class="media-object" src="assets/img/speaker-4.png" alt="...">
                        </a>
                      </div>
                      <div class="media-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="media">
                      <div class="media-left">
                        <a href="#">
                          <img class="media-object" src="assets/img/speaker-6.png" alt="...">
                        </a>
                      </div>
                      <div class="media-body">
                        <h4 class="media-heading">10am to 10:30am</h4>
                  ...
                  <div class="col-md-6">
                    <div class="media">
                      <div class="media-left">
                        <a href="#">
                          <img class="media-object" src="assets/img/speaker-5.png" alt="...">
                        </a>
                      </div>
                      <div class="media-body">
                        <h4 class="media-heading">10:45am to 11:30am</h4>
